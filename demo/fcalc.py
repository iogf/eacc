...
class CalcGrammar(Grammar):
    ...
    r_done0  = Rule(Sof, Expr, Eof)
    r_done1  = Rule(Sof, Term, Eof)
    r_done2  = Rule(Sof, Factor, Eof)

    root = [r_plus, r_minus, r_expr, r_mul, r_div, r_factor, r_term, r_paren, r_done0, r_done1, r_done2]
...
eacc.add_handle(CalcGrammar.r_done2, done)
eacc.add_handle(CalcGrammar.r_done1, done)
eacc.add_handle(CalcGrammar.r_done0, done)
